...
<body>
    <nav>
        <label class="logo">MUS_NFT</label>
        <ul>
    ...
    <div class="container">
        ...
        foreach ($list as $key => $value) { ?>
            <div class="card">
                <div class="imgBx"  style="height:150px;">
                ...
                <div class="content">
                    ...
                    <div class="original-price"  style="text-align: center;">
                        <?php
                    ...
                    <div class="price" style="text-align: center;">
                        Giá bán: <?= number_format($value['promotionPrice'], 0, '', ',') ?>ETH
                    </div>
                    <!-- <div class="rating">
                        <div class="rating">
    ...
    <footer>
        ...
        <p class="copyright">MUS_NFT @ 2024 kous1608</p>
    </footer>
</body>
