        ...
        if ($list) { ?>
            <table class="order">
                ...
                foreach ($list as $key => $value) { ?>
                    <tr>
                        ...
                        <td><?= number_format($value['productPrice'], 0, '', ',') ?>ETH </td>
                        <td>
            ...
            <div class="orderinfo">
                <div class="buy">
                    ...
                    <div>
                        Tổng tiền: <b id="totalcart"><?= number_format($totalPrice['total'], 0, '', ',') ?>ETH</b>
                    </div>
                    <div>
        ...
        http.onreadystatechange = function() {
            if (http.readyState === XMLHttpRequest.DONE) {
                ...
                if (status === 200) {
                    ...
                    document.getElementById("totalcart").innerHTML = arrResult[0]['total'].replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + "ETH";
